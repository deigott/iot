...
curl -sfL https://get.k3s.io | K3S_TOKEN_FILE=${K3S_TOKEN_FILE} K3S_URL="https://192.168.56.110:6443" INSTALL_K3S_EXEC="agent --flannel-iface=eth1" sh - && echo "[INFO] Worker is configured."
